...
from fastapi import APIRouter, Depends, Query  # routing / DI; 404/409 come from resolve_parsed_resume
...
from sqlalchemy import select  # active+embedded postings query
...
from app.services.resume_selection import resolve_parsed_resume  # same 404/409 rules as POST /interviews
...
async def list_matches(
    ...
    resume = await resolve_parsed_resume(session, current_user, resume_id)
